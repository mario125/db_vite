...
create table t_product_category(
    t_product_category_id varchar(50) not null primary key,
    t_product_category_name varchar(50) COMMENT ' BEBIDA, JUGO, CEVICHE',
    t_product_category_image varchar(100),
    t_product_category_desdcription varchar(100),
    t_product_category_status int,
    t_prodcut_category_order int,
);
...
create table t_order(
    ...
    order_city varchar(20) COMMENT 'para identificar a que ciudad pertense.',
    order_status int,
    id_driver int,
    id_user int,
    id_type_payment int,
